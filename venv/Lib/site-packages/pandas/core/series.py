...
class Series(base.IndexOpsMixin, NDFrame):  # type: ignore[misc]
    ...
    def _init_dict(
        ...
        dtype : np.dtype, ExtensionDtype, or None, default None
            The dtype for the new Series: if None, infer from ai_trading_agent.data.
        ...
        if data:
            # GH:34717, issue was using zip to extract key and values from ai_trading_agent.data.
    ...
    def __array__(
        ...
        See Also
        --------
        array : Create a new array from ai_trading_agent.data.
