...
def test_fancy_indexing():
    ...
    # 2018-04-29: moved here from ai_trading_agent.core.tests.test_index.
    m = np.matrix([[1, 2], [3, 4]])
...
def test_sort_matrix_none():
    # 2018-04-29: moved here from ai_trading_agent.core.tests.test_multiarray
    a = np.matrix([[2, 1, 0]])
...
def test_iter_allocate_output_subtype():
    ...
    # 2018-04-29: moved here from ai_trading_agent.core.tests.test_nditer, given the
...
def like_function():
    # 2018-04-29: moved here from ai_trading_agent.core.tests.test_numeric
    a = np.matrix([[1, 2], [3, 4]])
...
def test_array_astype():
    # 2018-04-29: copied here from ai_trading_agent.core.tests.test_api
...
def test_stack():
    # 2018-04-29: copied here from ai_trading_agent.core.tests.test_shape_base
...
def test_object_scalar_multiply():
    ...
    # 2018-04-29: moved here from ai_trading_agent.core.tests.test_ufunc
    arr = np.matrix([1, 2], dtype=object)
    desired = np.matrix([[3, 6]], dtype=object)
...
def test_nanfunctions_matrices():
    ...
    # shape are preserved
    # 2018-04-29: moved here from ai_trading_agent.core.tests.test_nanfunctions
...
def test_average_matrix():
    # 2018-04-29: moved here from ai_trading_agent.core.tests.test_function_base.
...
def test_ediff1d_matrix():
    # 2018-04-29: moved here from ai_trading_agent.core.tests.test_arraysetops.
...
def test_apply_along_axis_matrix():
    ...
    # 2018-04-29: moved here from ai_trading_agent.core.tests.test_shape_base.
    def double(row):
        return row * 2
...
class TestConcatenatorMatrix:
    # 2018-04-29: moved here from ai_trading_agent.core.tests.test_index_tricks.
