...
import json
import os
from streamlit_autorefresh import st_autorefresh  # Importar st_autorefresh


# Ficheiros de log
PERFORMANCE_FILE = "AI_TRADING_AGENT_PROJECT/ai_trading_agent/data/performance_log.json"
TRADES_FILE = "AI_TRADING_AGENT_PROJECT/ai_trading_agent/data/trades_log.json"
STATUS_FILE = "AI_TRADING_AGENT_PROJECT/ai_trading_agent/data/agent_status.json"
